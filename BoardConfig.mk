...
TARGET_PREBUILT_KERNEL := device/asus/tf701t/kernel

#TARGET_KERNEL_SOURCE := kernel/asus/tf701t
#TARGET_KERNEL_CONFIG := katkernel_defconfig
#TARGET_KERNEL_CONFIG := recovery_tf701t_defconfig
...
TARGET_RECOVERY_FSTAB := device/asus/tf701t/recovery/twrp.fstab
